            ...
            <main className="pa4 black-80">
                <form className="measure">
                    <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
                        ...
                        <label className="pa0 ma0 lh-copy white f6 pointer" ><input type="checkbox" /> Remember me</label>
                    </fieldset>
                    <div className="">
                        <input className="b ph3 pv2 input-reset ba b--black bg-transparent grow pointer f6 dib white" onClick={onRouteChange} type="submit" value="Sign in" />
                    </div>
                    <div className="lh-copy mt3">
                        <p onClick={onRouteChange('register')} className="f6 link dim black db white">Register</p>
                    </div>
                </form>
            </main>
        </article>
